...
// Explanation: AlgorithmAnalysis1
...
// be O(N+M). Since variables size does not depend on the size of the input,
// therefore Space Complexity will be constant or O(1)


// Explanation: AlgorithmAnalysis2
// If you notice, j keeps doubling till it is less than or equal
// to n. Several times, we can double a number till it is less than n would
// be log(n).
